...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Emily Experience Brand
        'emily-purple': '#6B21A8',
        'emily-purple-light': '#9333EA',
        'emily-purple-dark': '#581C87',
        'emily-gold': '#D4AF37',
        'emily-gold-light': '#F3E5AB',
        'emily-gold-dark': '#B8960C',
        'emily-dark': '#0F0A1A',
        'emily-card': '#261845',
        'emily-card-light': '#1A1033',
      ...
      boxShadow: {
        'glow': '0 4px 30px rgba(107, 33, 168, 0.15)',
        'glow-lg': '0 8px 40px rgba(107, 33, 168, 0.25)',
